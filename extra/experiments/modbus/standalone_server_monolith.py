...
def main():
    ...
    simulator_config  = {
        "grofera" : {
            ...
            "orange"  : { "register_alloc": [8,9] }          # in HR index 8 will contain prod_amount, index 9 will contain last prod time for peach
        }
    }
...
class Monolith:
    ...
    def configure(self):
        ...
        simulator_address = ("localhost", 11204)
        simulator_config  = {"grofera" : {"orange"  : { "register_alloc": [8,9]}}}
